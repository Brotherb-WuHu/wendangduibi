...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    a: $data.width,
    b: $data.height,
    c: common_vendor.sr("lsjUpload", "bf6b9346-0"),
    d: common_vendor.o(() => {
    }),
    ...
    i: common_vendor.sr("suspop", "bf6b9346-1"),
    j: common_vendor.p({
      type: "message"
    }),
    k: common_vendor.p({
    ...
    l: common_vendor.sr("faipop", "bf6b9346-3"),
    m: common_vendor.p({
      type: "message"
    }),
...
var MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "D:/vue/brotherb/pages/upload1/upload1.vue"]]);
